...
async function gloryList(req, res) {
  try {
    ...
    const MY_CLAN_TAG = `#${process.env.CLAN_TAG}` || "#2PQ292802";
    const MY_CLAN_NAME = process.env.CLAN_NAME || "Polska Husaria";
    ...
    const playersData = players.map((player) => {
      ...
      return {
        ...
        totalDefStars,
        totalDefDest: parseFloat(totalDefDest.toFixed(1)),
